...
export default async function QualidadeWhatsappPage({
  ...
  return (
    <div>
      ...
      <form action={criarBmConta} className="card" style={{ display: "grid", gap: 10, maxWidth: 480 }}>
        <div>
          <label className="field-label" htmlFor="nova-bm-nome">
            Nome/apelido da BM
          </label>
          <input id="nova-bm-nome" name="nome" type="text" placeholder="Ex.: VieiraCred" required />
        </div>
        <div>
        ...
        <button type="submit">Adicionar BM</button>
      </form>
